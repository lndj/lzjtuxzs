...
// +----------------------------------------------------------------------
// | Optimizated:Luo Ning <luoning@luoning.me> <http://www.luoning.me>
// +----------------------------------------------------------------------
namespace Lib\Wechat;
use Lib\Wechat\WechatCrypt;
...
class Wechat {
     ...
     * @param string $aeskey   消息加密KEY (EncodingAESKey)
     */
    public function __construct($token, $appid = '', $aeskey = ''){
        //设置安全模式
